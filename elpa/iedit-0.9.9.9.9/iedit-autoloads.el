...

;;; Generated autoloads from iedit-tests.el

(register-definition-prefixes "iedit-tests" '("foo" "goto-word" "iedit-printable-test-lists" "marker-position-list" "with-iedit-test-"))

;;; End of scraped data
